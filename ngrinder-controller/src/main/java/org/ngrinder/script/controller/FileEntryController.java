...
public class FileEntryController extends BaseController {
	...
	/**
	 * Convert the HAR format file with template.
	 *
	...
	@ResponseBody
	public String convertToFile(@RequestParam("uploadFile") MultipartFile file,
	...
	/**
	 * Convert textarea string with template.
	 *
	...
	public Map<String, Object> convertToTextarea(@RequestParam(value = "harContent", required = true) String harContent,
		...
		return fileEntryService.convertToTemplate(harContent, removeStaticResource);
	}
